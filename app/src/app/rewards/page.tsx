...
export default function RewardsPage() {
  ...
  const {
    ...
    loadingMore: epochsLoadingMore,
    hasMore: hasMoreEpochs,
    loadMore: loadMoreEpochs,
          ...
          <section className="mb-8">
            ...
            {hasMoreEpochs && (
              <div className="mt-4 flex justify-center">
                <button
                  type="button"
                  onClick={loadMoreEpochs}
                  disabled={epochsLoadingMore}
                  className="rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 dark:border-gray-800 dark:text-gray-300 dark:hover:bg-gray-800"
                >
                  {epochsLoadingMore ? "Loading…" : "Load more"}
                </button>
              </div>
            )}
          </section>
